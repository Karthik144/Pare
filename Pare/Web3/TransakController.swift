...
//        WebView(url: URL(string: "https://global-stg.transak.com/?apiKey=d66d374c-d314-452e-ad13-3fbfc6e1319f&network=polygon&defaultCryptoCurrency=USDC&environment=STAGING&disableWalletAddressForm=true&cryptoCurrencyList=USDC&walletAddress=\(publicAddress)&fiatCurrency=USD&defaultFiatAmount=30&hideMenu=true&themeColor=2B4AEE&productsAvailed=BUY&exchangeScreenTitle=Add%20coins%20to%20your%20wallet.&userData=%7B%22firstName%22%3A%22\(firstName)%22%2C%22lastName%22%3A%22\(lastName)%22%2C%22email%22%3A%22\(emailUsername)%40\(emailDomain)")
