...
//  Pare
//
//  Created by Akhil Maheepathi on 4/5/23.
//
...
class web3ViewModel: ObservableObject {
    ...
    func sendTx(to: String, value: Int) {
        ...
        //Note to self: all transaction shit needs to be in Hex
        let tx = Client.Transaction(
            ...
            type: nil,
            accessList: nil,
            chainId: "0x" + String(137, radix: 16),
...
extension web3ViewModel: WalletConnectDelegate {
